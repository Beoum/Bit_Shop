...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<c:forEach var="i" begin="0" end="${fn:length(list) - 1}">
		...
		<td align="center">
			<a href="/purchase/getPurchase?tranNo=${list[i].tranNo }&currentPage=${resultPage.currentPage}">${list[i].purchaseProd.prodName }</a>
		</td>
		<td></td>
		<td align="left">
			<a href="/user/getUser?userId=${list[0].buyer.userId}">${list[i].buyer.userId }</a>			
		</td>
		<td></td>
