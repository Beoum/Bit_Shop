...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">받는사람 연락처</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
		...
		<td align="center">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;" id="addPurchaseButton">
						구매
					</td>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;" id="cancelButton">
						취소
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
